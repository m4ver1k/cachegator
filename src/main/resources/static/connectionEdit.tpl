...
<div class="row" ng-controller="EditConnection">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Edit Connection</div>
			<div class="panel-body">
					<div class="form-group">
						<label for="conList">select connection</label> 
					...
					<button type="button" class="btn btn-primary"
						ng-click="editConnection()">Save</button>
				</div>
			</div>
		</div>
		<div class="modal fade" id="conSave" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">Connection Saved successfully.</div>
